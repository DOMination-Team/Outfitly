...
export const myWardrobeSearchParams = {
  ...
  sortBy: parseAsStringEnum<WardrobeSortBy>(createArrayFromDiscriminatedUnion<WardrobeSortBy>(
    "addedAt",
    "name",
  )).withDefault("addedAt"),
  sortOrder: parseAsStringEnum<SortOrder>(createArrayFromDiscriminatedUnion<SortOrder>(
    "asc",
    "desc"
  )).withDefault("asc")
}
