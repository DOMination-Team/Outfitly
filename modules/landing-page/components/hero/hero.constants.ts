...
export const HERO_BACKGROUND_IMAGE = "/hero-image.png";
...
export const GRADIENT_COLORS = {
  light: {
    overlay:
      "linear-gradient(135deg, rgba(103, 20, 37, 0.48), rgba(139, 29, 53, 0.40), rgba(76, 20, 32, 0.55))",
    bottom: "linear-gradient(to top, rgba(250, 241, 237, 0), transparent)",
  },
  dark: {
    overlay:
      "linear-gradient(135deg, rgba(103, 20, 37, 0.62), rgba(139, 29, 53, 0.52), rgba(76, 20, 32, 0.68))",
    bottom: "linear-gradient(to top, rgba(26, 26, 26, 0.96), transparent)",
  },
} as const;
